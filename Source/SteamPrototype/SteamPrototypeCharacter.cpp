...
ASteamPrototypeCharacter::ASteamPrototypeCharacter()
{
...
void ASteamPrototypeCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void ASteamPrototypeCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
...
void ASteamPrototypeCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
...
void ASteamPrototypeCharacter::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) )
	{
